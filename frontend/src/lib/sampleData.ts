...
export const SAMPLE_CHICKENS: Chicken[] = [
  {
    ...
    status: "available", is_featured: true, cover_image: "/images/chicken-1.svg", images: [],
  },
  {
    ...
    status: "available", is_featured: true, cover_image: "/images/chicken-2.svg", images: [],
  },
  {
    ...
    status: "available", is_featured: false, cover_image: "/images/chicken-3.svg", images: [],
  },
  {
    ...
    status: "available", is_featured: false, cover_image: "/images/chicken-4.svg", images: [],
  },
];
