...
const T = {
  en: {
    nav: { home: "Home", chickens: "Our Naati Kodi", farm: "Our Farm", buy: "How to Buy", visit: "Farm Visit", franchise: "Franchise", whyUs: "Why Choose Us", contact: "Contact" },
    hero: {
      badge: "Pure Country Chicken · Raised Naturally",
      title1: "SR NAATI KODI",
      title2: "FARMS",
      sub: "Pure Country Chicken\nRaised Naturally",
      tag: "Traditional Taste  |  Natural Farming  |  Farm Fresh",
      desc: "Authentic Naati Kodi raised in open farms with natural feeding, fresh water, free roaming, healthy environment and traditional farming methods.",
      btnView: "View Naati Kodi",
    ...
    story: {
      eyebrow: "Our Story",
      title: "Why SR Naati Kodi Farms?",
      desc: "We raise Naati Kodi the way nature intended — free to roam under open skies, fed on natural grains and fresh water, grown slowly with patience. No factory cages. No artificial methods. Just honest, traditional farming that brings out the authentic taste country chicken is loved for.",
      points: [
    ...
    visitCta: {
      ...
      desc: "Book a free farm visit. Walk the pasture, meet the birds, and choose your Naati Kodi the traditional way. No advance payment required.",
      btn: "Book Farm Visit",
    ...
    franchise: {
      ...
      title: "Start Your Own\nSR Naati Kodi Franchise",
      desc: "Build your own business with authentic farm-raised Naati Kodi birds and eggs. We support every franchise partner with supply, training and ongoing guidance.",
      supplyTitle: "We supply franchise partners with:",
      supply: ["Pure Naati Kodi birds", "Fresh farm eggs", "Quality farm products", "Business guidance & training"],
      options: [
        { n: "01", title: "SR Naati Kodi Birds Franchise", desc: "Supply and sell authentic live Naati Kodi birds in your locality." },
        { n: "02", title: "Meat & Eggs Franchise", desc: "Operate a fresh Naati Kodi meat and farm egg retail outlet." },
        { n: "03", title: "Retail Outlet Franchise", desc: "Set up a branded SR Naati Kodi retail store in your area." },
  ...
  te: {
    nav: { home: "హోమ్", chickens: "నాటి కోడి", farm: "మా ఫార్మ్", buy: "కొనుగోలు", visit: "సందర్శన", franchise: "ఫ్రాంచైజ్", whyUs: "ఎందుకు మేము", contact: "సంప్రదించు" },
    hero: {
      badge: "స్వచ్ఛమైన నాటి కోడి · సహజంగా పెంచబడినది",
      title1: "SR నాటి కోడి",
      title2: "ఫార్మ్స్",
      sub: "స్వచ్ఛమైన నాటి కోడి\nసహజంగా పెంచబడినది",
      tag: "సంప్రదాయ రుచి  |  సహజ వ్యవసాయం  |  తాజా ఫార్మ్",
      desc: "సహజ ఆహారం, తాజా నీరు, స్వేచ్ఛగా తిరగడం, ఆరోగ్యకరమైన వాతావరణంతో పెంచబడిన అసలైన నాటి కోడి.",
      btnView: "నాటి కోడి చూడండి",
    ...
    story: {
      eyebrow: "మా కథ",
      title: "SR నాటి కోడి ఫార్మ్స్ ఎందుకు?",
      desc: "మేము నాటి కోడిని ప్రకృతి చెప్పిన విధంగా పెంచుతాము — తెరిచిన ఆకాశం కింద స్వేచ్ఛగా తిరగడం, సహజ ధాన్యాలు తినడం, నెమ్మదిగా పెరగడం. ఫ్యాక్టరీ పంజరాలు లేవు. కృత్రిమ పద్ధతులు లేవు. నిజాయితీగా సంప్రదాయ వ్యవసాయం.",
      points: [
        ...
        "తాజా, ఆరోగ్యకరమైన నాటి కోడి",
        "నేరుగా ఫార్మ్ నుండి కస్టమర్‌కు అనుభవం",
      ],
      quote: "గ్రామ రుచి, మీ ఇంటికి.",
    },
    products: { eyebrow: "మా సేకరణ", title: "నాటి కోడి సేకరణ", desc: "ప్రతి పక్షి కిలో ధరలో అమ్ముతారు. ఫార్మ్ సందర్శించి, మీ పక్షిని ఎంచుకుని, జీవితో తూకం వేయండి." },
    ...
    franchise: {
      eyebrow: "వ్యాపార అవకాశం", title: "SR నాటి కోడి\nఫ్రాంచైజ్ ప్రారంభించండి", desc: "నాటి కోడి పక్షులు మరియు గుడ్లతో మీ స్వంత వ్యాపారం నిర్మించండి.",
      supplyTitle: "మేము ఫ్రాంచైజ్ భాగస్వాములకు సరఫరా చేస్తాము:", supply: ["స్వచ్ఛమైన నాటి కోడి పక్షులు", "తాజా ఫార్మ్ గుడ్లు", "నాణ్యమైన ఫార్మ్ ఉత్పత్తులు", "వ్యాపార మార్గదర్శకత్వం & శిక్షణ"],
      options: [{ n: "01", title: "SR నాటి కోడి పక్షులు ఫ్రాంచైజ్", desc: "మీ ప్రాంతంలో అసలైన నాటి కోడి అమ్మండి." }, { n: "02", title: "మాంసం & గుడ్ల ఫ్రాంచైజ్", desc: "తాజా నాటి కోడి మాంసం మరియు గుడ్ల రిటైల్ షాప్." }, { n: "03", title: "రిటైల్ అవుట్‌లెట్ ఫ్రాంచైజ్", desc: "SR నాటి కోడి బ్రాండ్ రిటైల్ స్టోర్ నిర్వహించండి." }, { n: "04", title: "మీ స్వంత వ్యాపారం", desc: "బ్రాండింగ్, శిక్షణ మరియు నిరంతర మద్దతుతో పూర్తి వ్యాపార సెటప్." }],
  ...
  kn: {
    nav: { home: "ಮನೆ", chickens: "ನಾಟಿ ಕೋಡಿ", farm: "ನಮ್ಮ ಫಾರ್ಮ್", buy: "ಖರೀದಿ", visit: "ಫಾರ್ಮ್ ಭೇಟಿ", franchise: "ಫ್ರಾಂಚೈಸ್", whyUs: "ನಾವೇಕೆ", contact: "ಸಂಪರ್ಕ" },
    hero: {
      badge: "ಶುದ್ಧ ನಾಟಿ ಕೋಡಿ · ಸ್ವಾಭಾವಿಕವಾಗಿ ಸಾಕಿದ",
      title1: "SR ನಾಟಿ ಕೋಡಿ",
      title2: "ಫಾರ್ಮ್ಸ್",
      sub: "ಶುದ್ಧ ನಾಟಿ ಕೋಡಿ\nಸ್ವಾಭಾವಿಕವಾಗಿ ಸಾಕಿದ",
      tag: "ಸಾಂಪ್ರದಾಯಿಕ ರುಚಿ  |  ನೈಸರ್ಗಿಕ ಕೃಷಿ  |  ಫಾರ್ಮ್ ತಾಜಾ",
      desc: "ನೈಸರ್ಗಿಕ ಆಹಾರ, ತಾಜಾ ನೀರು, ಮುಕ್ತ ಓಡಾಟ, ಆರೋಗ್ಯಕರ ವಾತಾವರಣ ಮತ್ತು ಸಾಂಪ್ರದಾಯಿಕ ಕೃಷಿ ವಿಧಾನಗಳೊಂದಿಗೆ ಬೆಳೆಸಿದ ನಿಜವಾದ ನಾಟಿ ಕೋಡಿ.",
      btnView: "ನಾಟಿ ಕೋಡಿ ನೋಡಿ",
    ...
    story: { eyebrow: "ನಮ್ಮ ಕಥೆ", title: "SR ನಾಟಿ ಕೋಡಿ ಫಾರ್ಮ್ಸ್ ಏಕೆ?", desc: "ಪ್ರಕೃತಿ ಸೂಚಿಸಿದಂತೆ ನಾಟಿ ಕೋಡಿ ಸಾಕುತ್ತೇವೆ — ಮುಕ್ತ ಆಕಾಶದಡಿ, ನೈಸರ್ಗಿಕ ಆಹಾರ, ನಿಧಾನ ಬೆಳವಣಿಗೆ.", points: ["ತೆರೆದ ಮೇವಿನಲ್ಲಿ ನೈಸರ್ಗಿಕ ಸಾಕಣೆ", "ತೆರೆದ ಆಕಾಶದಡಿ ಮುಕ್ತ ಚಲನೆ", "ಸಾಂಪ್ರದಾಯಿಕ ಆಹಾರ ಅಭ್ಯಾಸ", "ಕೃತಕ ಹಾರ್ಮೋನ್ ಇಲ್ಲ", "ತಾಜಾ ಮತ್ತು ಆರೋಗ್ಯಕರ ನಾಟಿ ಕೋಡಿ", "ನೇರ ಫಾರ್ಮ್-ಗ್ರಾಹಕ ಅನುಭವ"], quote: "ಹಳ್ಳಿ ರುಚಿ, ನಿಮ್ಮ ಮನೆಗೆ." },
    products: { eyebrow: "ನಮ್ಮ ಸಂಗ್ರಹ", title: "ನಾಟಿ ಕೋಡಿ ಸಂಗ್ರಹ", desc: "ಫಾರ್ಮ್ ಭೇಟಿ ಮಾಡಿ, ಪಕ್ಷಿ ಆರಿಸಿ, ನೇರ ತೂಕ ಮಾಡಿ." },
    ...
    franchise: { eyebrow: "ವ್ಯಾಪಾರ ಅವಕಾಶ", title: "SR ನಾಟಿ ಕೋಡಿ\nಫ್ರಾಂಚೈಸ್ ಪ್ರಾರಂಭಿಸಿ", desc: "ನಾಟಿ ಕೋಡಿ ಪಕ್ಷಿಗಳು ಮತ್ತು ಮೊಟ್ಟೆಗಳೊಂದಿಗೆ ನಿಮ್ಮ ಸ್ವಂತ ವ್ಯಾಪಾರ ನಿರ್ಮಿಸಿ.", supplyTitle: "ನಾವು ಒದಗಿಸುವುದು:", supply: ["ಶುದ್ಧ ನಾಟಿ ಕೋಡಿ ಪಕ್ಷಿಗಳು", "ತಾಜಾ ಮೊಟ್ಟೆಗಳು", "ಗುಣಮಟ್ಟದ ಉತ್ಪನ್ನಗಳು", "ವ್ಯಾಪಾರ ಮಾರ್ಗದರ್ಶನ"], options: [{ n: "01", title: "ನಾಟಿ ಕೋಡಿ ಪಕ್ಷಿ ಫ್ರಾಂಚೈಸ್", desc: "ನಿಮ್ಮ ಪ್ರದೇಶದಲ್ಲಿ ನಾಟಿ ಕೋಡಿ ಮಾರಿ." }, { n: "02", title: "ಮಾಂಸ & ಮೊಟ್ಟೆ ಫ್ರಾಂಚೈಸ್", desc: "ತಾಜಾ ಮಾಂಸ ಮತ್ತು ಮೊಟ್ಟೆ ಅಂಗಡಿ." }, { n: "03", title: "ರಿಟೇಲ್ ಔಟ್‌ಲೆಟ್ ಫ್ರಾಂಚೈಸ್", desc: "SR ಬ್ರಾಂಡ್ ರಿಟೇಲ್ ಸ್ಟೋರ್ ನಡೆಸಿ." }, { n: "04", title: "ನಿಮ್ಮ ಸ್ವಂತ ಉದ್ಯಮ", desc: "ತರಬೇತಿ ಮತ್ತು ಬೆಂಬಲದೊಂದಿಗೆ ಪೂರ್ಣ ವ್ಯಾಪಾರ." }], btn: "ಫ್ರಾಂಚೈಸ್‌ಗೆ ಅರ್ಜಿ", btnNote: "ವಾಟ್ಸ್‌ಆ್ಯಪ್ ಮೂಲಕ" },
  ...
  ta: {
    nav: { home: "முகப்பு", chickens: "நாட்டி கோடி", farm: "எங்கள் பண்ணை", buy: "வாங்குவது", visit: "பண்ணை பார்வை", franchise: "உரிமை", whyUs: "ஏன் நாங்கள்", contact: "தொடர்பு" },
    hero: {
      badge: "தூய நாட்டி கோடி · இயற்கையாக வளர்க்கப்பட்டது",
      title1: "SR நாட்டி கோடி",
      title2: "ஃபார்ம்ஸ்",
      sub: "தூய நாட்டி கோடி\nஇயற்கையாக வளர்க்கப்பட்டது",
      tag: "பாரம்பரிய சுவை  |  இயற்கை விவசாயம்  |  பண்ணை புதியது",
      desc: "இயற்கை உணவு, சுத்தமான நீர், சுதந்திர ஓட்டம், ஆரோக்கியமான சூழல் மற்றும் பாரம்பரிய விவசாய முறைகளுடன் வளர்க்கப்பட்ட நாட்டி கோடி.",
      btnView: "நாட்டி கோடி பார்க்க",
    ...
    story: { eyebrow: "எங்கள் கதை", title: "SR நாட்டி கோடி ஃபார்ம்ஸ் ஏன்?", desc: "இயற்கை சொல்வதுபோல் நாட்டி கோடி வளர்க்கிறோம் — திறந்த வானத்தின் கீழ் சுதந்திரமாக, இயற்கை உணவு, மெதுவான வளர்ச்சி.", points: ["திறந்த மேய்ச்சலில் இயற்கையாக வளர்க்கப்பட்ட பறவைகள்", "திறந்த வானின் கீழ் சுதந்திர இயக்கம்", "பாரம்பரிய உணவு பழக்கங்கள்", "செயற்கை ஹார்மோன்கள் இல்லை", "புதிய மற்றும் ஆரோக்கியமான நாட்டி கோடி", "நேரடி பண்ணை-வாடிக்கையாளர் அனுபவம்"], quote: "கிராம சுவை, உங்கள் வீட்டிற்கு." },
    products: { eyebrow: "எங்கள் தொகுப்பு", title: "நாட்டி கோடி தொகுப்பு", desc: "பண்ணை பார்வையிட்டு பறவை தேர்ந்தெடுத்து நேரடியாக எடை பாருங்கள்." },
    ...
    franchise: { eyebrow: "வணிக வாய்ப்பு", title: "SR நாட்டி கோடி\nஃபிராஞ்சைஸ் தொடங்குங்கள்", desc: "நாட்டி கோடி பறவைகள் மற்றும் முட்டைகளுடன் உங்கள் சொந்த வணிகம் கட்டமைக்கவும்.", supplyTitle: "நாங்கள் வழங்குவோம்:", supply: ["தூய நாட்டி கோடி பறவைகள்", "புதிய பண்ணை முட்டைகள்", "தரமான தயாரிப்புகள்", "வணிக வழிகாட்டுதல்"], options: [{ n: "01", title: "நாட்டி கோடி பறவை ஃபிராஞ்சைஸ்", desc: "உங்கள் பகுதியில் நாட்டி கோடி விற்கவும்." }, { n: "02", title: "இறைச்சி & முட்டை ஃபிராஞ்சைஸ்", desc: "புதிய இறைச்சி மற்றும் முட்டை சில்லறை கடை." }, { n: "03", title: "சில்லறை விற்பனை ஃபிராஞ்சைஸ்", desc: "SR பிராண்ட் சில்லறை கடை நடத்தவும்." }, { n: "04", title: "உங்கள் சொந்த நிறுவனம்", desc: "பயிற்சி மற்றும் ஆதரவுடன் முழு வணிக அமைப்பு." }], btn: "ஃபிராஞ்சைஸ்க்கு விண்ணப்பிக்கவும்", btnNote: "வாட்ஸ்அப் மூலம் · விரைவான பதில்" },
