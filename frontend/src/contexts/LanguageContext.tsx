...
const T = {
  en: {
    ...
    franchise: {
      ...
      options: [
        { n: "01", title: "NATU KODI Birds Franchise", desc: "Supply and sell authentic live Natu Kodi birds in your locality." },
        { n: "02", title: "Meat & Eggs Franchise", desc: "Operate a fresh Natu Kodi meat and farm egg retail outlet." },
        { n: "03", title: "Retail Outlet Franchise", desc: "Set up a branded NATU KODI retail store in your area." },
  ...
  te: {
    ...
    story: {
      eyebrow: "మా కథ",
      title: "నాటు కోడి ఫార్మ్స్ ఎందుకు?",
    ...
    franchise: {
      ...
      options: [{ n: "01", title: "నాటు కోడి పక్షులు ఫ్రాంచైజ్", desc: "మీ ప్రాంతంలో అసలైన నాటు కోడి అమ్మండి." }, { n: "02", title: "మాంసం & గుడ్ల ఫ్రాంచైజ్", desc: "తాజా నాటు కోడి మాంసం మరియు గుడ్ల రిటైల్ షాప్." }, { n: "03", title: "రిటైల్ అవుట్‌లెట్ ఫ్రాంచైజ్", desc: "నాటు కోడి బ్రాండ్ రిటైల్ స్టోర్ నిర్వహించండి." }, { n: "04", title: "మీ స్వంత వ్యాపారం", desc: "బ్రాండింగ్, శిక్షణ మరియు నిరంతర మద్దతుతో పూర్తి వ్యాపార సెటప్." }],
  ...
  ta: {
    ...
    franchise: { eyebrow: "வணிக வாய்ப்பு", title: "நாட்டு கோடி\nஃபிராஞ்சைஸ் தொடங்குங்கள்", desc: "நாட்டு கோடி பறவைகள் மற்றும் முட்டைகளுடன் உங்கள் சொந்த வணிகம் கட்டமைக்கவும்.", supplyTitle: "நாங்கள் வழங்குவோம்:", supply: ["தூய நாட்டு கோடி பறவைகள்", "புதிய பண்ணை முட்டைகள்", "தரமான தயாரிப்புகள்", "வணிக வழிகாட்டுதல்"], options: [{ n: "01", title: "நாட்டு கோடி பறவை ஃபிராஞ்சைஸ்", desc: "உங்கள் பகுதியில் நாட்டு கோடி விற்கவும்." }, { n: "02", title: "இறைச்சி & முட்டை ஃபிராஞ்சைஸ்", desc: "புதிய இறைச்சி மற்றும் முட்டை சில்லறை கடை." }, { n: "03", title: "சில்லறை விற்பனை ஃபிராஞ்சைஸ்", desc: "Natu Kodi பிராண்ட் சில்லறை கடை நடத்தவும்." }, { n: "04", title: "உங்கள் சொந்த நிறுவனம்", desc: "பயிற்சி மற்றும் ஆதரவுடன் முழு வணிக அமைப்பு." }], btn: "ஃபிராஞ்சைஸ்க்கு விண்ணப்பிக்கவும்", btnNote: "வாட்ஸ்அப் மூலம் · விரைவான பதில்" },
