...
export const metadata: Metadata = {
  title: "Available Natu Kodi",
  description: "Browse all naturally raised country chickens available at SR Natu Kodi Farms.",
};
  ...
  return (
    <section className="container-x py-16">
      <div className="mb-10 text-center reveal">
        ...
        <h1 className="section-title mt-2 text-4xl sm:text-5xl">Available Natu Kodi</h1>
